...
11. 发布页只负责整理和发布照片。返回 `/admin/quick-listings` 后，在“当前新品展台”中从所有未归档商品跨批次选择 2–8 件。
12. 使用箭头调整顺序、指定一件主推，再选择“新品橱窗”或“快乐手账”并保存。保存会整体替换前台当前展台；未选入的可见商品仍在“更多新鲜好物”区域展示。若显示“系统建议组合”，表示尚未固定，应确认后主动保存一次。
